...
library(rMaps)
map<-Leaflet$new()
map$setView(c(2.86462,101.676951),zoom=13)
map$marker(c(2.86462,101.676951), bindPopup = "<p> Best Laundry in Selangor </p>")
map$save('map.html',cdn=TRUE)
cat('<iframe src="map.html" width=70%, height=70%></iframe>')
```
